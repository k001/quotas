...
% CAPITULO INTRODUCCION.Tiene por objeto proporcionar una visión general del documento.
...
%Este trabajo recepcional presenta el desarrollo de los temas que fueron necesarios para la elaboraci\'on de un proyecto en el \emph{DIF Municipal de Zapopan}.\\
%Este documento presenta la explicaci\'on del \emph{porqu\'e, para qu\'e} y \emph{c\'omo} fue desarrollado el \emph{Proyecto de Automatizaci\'on del Control de las Adquisiciones} efectuadas por la Instituci\'on antes mencionada.\\
%Dicha automatizaci\'on fue requerida por el \emph{C. Ing. Juan Rodolfo Villaseñor P\'erez}. El prop\'osito principal del proyecto fue la agilizaci\'on y actualizaci\'on de requisici\'on de materiales necesarios en el propio \emph{Sistema DIF Municipal Zapopan}.\\

\newpage

% CAPITULO ANTECEDENTES Y DESCRIPCIÓN DE LA EMPRESA. Una breve historia y estatus de la empresa en el mercado, misiòn, visiòn, ubicación, etc.
\chapter{Creaci'on de una encuesta}
\newpage

\section{\text{Elementos b'asicos de una encuesta}}
...
%CAPITULO MARCO TEORICO(bases teòricas del proyecto) Y DESARROLLO DEL PROYECTO (procedimiento o descripción de las actividades realizadaas)
